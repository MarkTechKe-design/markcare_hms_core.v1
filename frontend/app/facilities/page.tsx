        ...
        <section className="border-b border-border bg-card">
          <div className="mx-auto grid min-h-[calc(100vh-82px)] max-w-[1500px] gap-8 px-5 py-8 md:px-8 lg:grid-cols-[0.8fr_1.2fr] lg:items-center">
            <div className="space-y-5">
              ...
              <Button asChild className="rounded-md bg-primary text-primary-foreground hover:brightness-110">
                <Link href="/login">
                  Enter the system
          ...
          {facilityCards.map((item) => {
            ...
            return (
              <article key={item.title} className="border border-border bg-card p-5 shadow-sm">
                <div className="mb-4 flex h-12 w-12 items-center justify-center border border-border bg-muted text-primary">
