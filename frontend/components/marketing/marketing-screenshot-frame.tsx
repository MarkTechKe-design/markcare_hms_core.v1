...
import { usePublicSettings, PublicSettingKey } from "@/hooks/use-public-settings";
...
export function MarketingScreenshotFrame({
  ...
  const resolvedSrc = React.useMemo(() => {
    if (src) return src;
    const settingKey = resolveSettingKey(title);
    return getSetting(settingKey);
  }, [src, title, getSetting]);
