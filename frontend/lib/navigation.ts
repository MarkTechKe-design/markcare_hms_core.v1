...
export const navSections: NavSection[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        href: "/ai-assistant",
        icon: Sparkles,
        keywords: ["gemini", "help"],
      },
      {
        title: "Patients",
        href: "/patients",
        icon: Users,
        keywords: ["register", "records"],
      },
      {
        title: "Appointments",
        href: "/appointments",
    ...
    items: [
      {
        ...
        href: "/consultation",
        icon: Stethoscope,
        keywords: ["doctor", "encounter"],
      },
      {
        title: "Triage & Vitals",
        href: "/triage",
        icon: HeartPulse,
        keywords: ["vitals", "nurse"],
      },
    ...
    items: [
      {
        ...
        href: "/pharmacy",
        icon: Pill,
        keywords: ["prescriptions", "medicines"],
      },
      {
        title: "OTC Sales",
        href: "/pharmacy/otc-sales",
        icon: ShoppingCart,
        keywords: ["walk-in", "sale"],
      },
      {
        title: "Branch Stock",
        href: "/pharmacy-stock",
